...
public class LancamentoController {
	...
	public List<Lancamento> filtrarLancamentos(
		...
		teste = tipo;
		return lancamentoService.filtrarLancamentos(id, tipo, valor, null);
	}
	
	@PostMapping
	public Lancamento salvar(@RequestBody Lancamento lancamento) throws NegocioExeption {
		if(lancamento.getTipo() == null) {
			throw new NegocioExeption("Campo 'situacao' nao pode ser nulo. ", NegocioExeption.BADREQUEST);
		}
		return lancamentoService.salvar(lancamento);
	}
	
	@PutMapping
	public Lancamento atualizar(@RequestBody Lancamento lancamento) throws NegocioExeption {
